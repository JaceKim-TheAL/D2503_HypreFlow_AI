...
- [[3-1.하이퍼플로우 슈퍼 노드 및 서비스 어댑터 사용자 가이드]](./hf_user_guide_1.md)
- [[3-2.FAISS 벡터 DB 활용을 위한 실전 가이드]](./hf_user_guide_2.md)
- [[3-3.챗봇 스타일링 고급 설정 가이드]](./hf_user_guide_3.md)
- [[3-4.프롬프트 템플릿 설정 가이드]](./hf_user_guide_4.md)
- [[3-5.RAG 애플리케이션에서 출처 인용을 지시하는 팁/가이드]](./hf_user_guide_5.md)
...
- Sub-Index
  ...
  - [출처 표시 설정](#출처-표시-설정)
  - [전반 설정](#전반-설정)
  - [CSS 스타일링 커스터마이징](#css-스타일링-커스터마이징)
    - [CSS 애니메이션 예시](#css-애니메이션-예시)
    - [커스텀 폰트 예시](#커스텀-폰트-예시)
  - [라벨 커스터마이징](#라벨-커스터마이징)
  - [스타일링 팁](#스타일링-팁)
  - [자주 사용하는 커스터마이징 예시](#자주-사용하는-커스터마이징-예시)
    - [메시지 말풍선 색상 변경](#메시지-말풍선-색상-변경)
    - [커스텀 폰트와 글꼴 스타일](#커스텀-폰트와-글꼴-스타일)
    - [다크 모드](#다크-모드)
    - [피드백 버튼 스타일링](#피드백-버튼-스타일링)
  - [전체 커스터마이징 예시](#전체-커스터마이징-예시)
...
이 가이드는 **EmbeddableBot**의 **외형과 동작을 고급 스타일 옵션으로 커스터마이징하는 방법**을 설명합니다. <br/>
이러한 설정을 통해 챗봇의 **디자인과 사용자 경험을 브랜드 정체성** 또는 **특정 활용 목적**에 맞게 조정할 수 있습니다.
